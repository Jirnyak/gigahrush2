...
> разработки с августа, закрыта и остаётся в репозитории только как архив: её
> дерево совпало с `main` на слиянии `832796e0`, и новых коммитов она не
> получает. Ритуал «main принимает торовую линию» умер вместе с ней — принимать
> больше нечего и неоткуда.
>
