...
console.log('Bezekhiy is standalone door-threshold content, not silent_polzun);
...
console.log('Bezekhiy sprite reads as a flat gray crawler with door-edge fingers);
...
console.log('Bezekhiy spends dead echo on a back-turned door crossing);
...
console.log('directly looking at Bezekhiy reveals it without the lunge);
  const world = openDoorWorld();
  setListenerPos(512, 512, world.dist2.bind(world));
