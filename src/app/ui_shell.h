...
enum class UiWindow : std::uint8_t {
    ...
    Craft,         // верстак — то же
    Elevator,      // меню кабины лифта
    // Dialog СНЕСЁН 2026-08-28 (вердикт владельца): зарезервированный
    // VN-оверлей без единого потребителя — «зарезервировано» держалось
    // годами как мёртвая строка перечисления.
};
