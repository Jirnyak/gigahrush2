...
struct VulkanRenderer {
    ...
    // 3D-режим Side-by-Side. Трубка в нём ГАСНЕТ принудительно, и это не
    // вкусовщина: бочка (crtCurvature) и виньетка считаются от центра ВСЕГО
    // кадра, а в стерео центр кадра — это шов между глазами. Искривление
    // тянет левую картинку вправо, правую влево, и стереопара рассыпается
    // тем сильнее, чем ближе к краям. Честная трубка в 3D — это трубка НА
    // ГЛАЗ, отдельный пост-пас; до тех пор — выключено.
    bool stereo3d = false;
