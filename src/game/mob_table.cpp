...
const std::array<MobDef, kMobKindCount> kMobTable = {{
    ...
    MobDef{ f(AiFlag::FoodBait),
             ...
             u8(MobPackMode::Crowd), 8, 16, 5, {0, 0} },
    // [1] TVAR
    MobDef{ f(AiFlag::FoodBait) | f(AiFlag::WallBias),
             ...
             u8(MobPackMode::Loner), 1, 1, 0, {0, 0} },
    // [2] POLZUN
    MobDef{ f(AiFlag::FoodBait),
    ...
    MobDef{ 0u,
             ...
             u8(MobPackMode::Crowd), 5, 10, 6, {0, 0} },
    // [5] EYE
    ...
    MobDef{ f(AiFlag::Rare),
             ...
             3, static_cast<std::uint8_t>(u8(FloorBit::ZPlus30) | u8(FloorBit::ZPlus14) | u8(FloorBit::Z0)),
             u8(MobPackMode::Roamer), 2, 3, 8, {0, 0} },
    // [26] KHOROVAYA_MATKA
    MobDef{ f(AiFlag::Rare),
    ...
    MobDef{ f(AiFlag::FoodBait),
             ...
             u8(MobPackMode::Territorial), 2, 4, 4, {0, 0} },
    // [30] BEZEKHIY
    MobDef{ 0u,
             58, 9, 1280, 1450, 1200,
    ...
    MobDef{ f(AiFlag::FoodBait),
             ...
             1, static_cast<std::uint8_t>(u8(FloorBit::ZPlus14) | u8(FloorBit::Z0) | u8(FloorBit::ZMinus26)),
             u8(MobPackMode::Crowd), 3, 6, 6, {0, 0} },
    // [60] SLIME_WOMAN
    MobDef{ f(AiFlag::Rare),
    ...
    MobDef{ 0u,
             ...
             u8(MobPackMode::Roamer), 2, 4, 10, {0, 0} },
    // [64] BLOOD_PLANT
    MobDef{ f(AiFlag::Rare) | f(AiFlag::Immobile),
             ...
             u8(MobPackMode::Territorial), 1, 3, 3, {0, 0} },
    // [65] SWARM
    MobDef{ f(AiFlag::FoodBait),
             12, 2, 2750, 240, 1050,
