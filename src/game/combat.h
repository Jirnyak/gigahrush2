...
// период мира — выстрел вдоль чистой линии может вернуться стрелку в затылок.
// Это ФИЧА тора, а не дефект: у нас топология, и всё работает. Кэп TTL по
// периметру здесь жил один коммит и был отменён владельцем; не возвращать.
