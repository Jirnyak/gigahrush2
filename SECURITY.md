...
We actively maintain and provide security patches for the following versions of **Jirnyak/gigahrush2**:
...
Security audits for **Jirnyak/gigahrush2** focus on the following attack surfaces and failure modes:

1. **Infinite BFS Loops**:  Cyclic graph traversal in disconnected voxel support trees causing browser freeze.
2. **WebGL Shader Exploits**:  Crafted voxel configurations triggering out-of-bounds uniform buffer writes in GPU pipeline.
3. **Memory Leaks in Mesh Regeneration**:  Retaining un-disposed WebGLBuffer handles across frequent carve operations.

---

## 🚨 3. Reporting a Vulnerability

If you discover a security vulnerability or exploit in **Jirnyak/gigahrush2**, please report it responsibly:
