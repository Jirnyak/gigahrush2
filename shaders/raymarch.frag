    ...
    if (!isHorizontal) {
        if (vMat == 8u) {
            ...
            if (wallpaperPattern == 0u) {
                basePaperCol = vec3(0.032, 0.024, 0.012);
            } else if (wallpaperPattern == 1u) {
                basePaperCol = vec3(0.012, 0.020, 0.008);
            } else {
                basePaperCol = vec3(0.028, 0.014, 0.008);
            }
            ...
            float h_in_room = fract(vWorldPos.y * 0.5);
            if (h_in_room < 0.70) {
                vec3 tileCol = (roomHash % 2u == 0u) ? vec3(0.018, 0.035, 0.022)
                                                     : vec3(0.045, 0.045, 0.038);
            ...
            if (h_in_room < 0.58) {
                ...
                vec3 oilPaintColor;
                if (colVar == 0u) oilPaintColor = vec3(0.012, 0.038, 0.075);
                else if (colVar == 1u) oilPaintColor = vec3(0.008, 0.035, 0.015);
                else oilPaintColor = vec3(0.035, 0.008, 0.004);
        ...
        if (vMat == 9u || vMat == 8u) {
            ...
            float grainT = vnoise(uv * 12.0);
            albedo = terrazzoCol * (0.88 + 0.24 * grainT);
            roughness = 0.60;
        }
    }
